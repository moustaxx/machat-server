...
import { LastReadUpdateManyWithoutPersonInput } from "../inputs/LastReadUpdateManyWithoutPersonInput";
...
@TypeGraphQL.InputType("PersonUpdateWithoutConversationsInput", {
  isAbstract: true
})
export class PersonUpdateWithoutConversationsInput {
  ...
  @TypeGraphQL.Field(_type => LastReadUpdateManyWithoutPersonInput, {
    nullable: true
  })
  lastRead?: LastReadUpdateManyWithoutPersonInput | undefined;
}
